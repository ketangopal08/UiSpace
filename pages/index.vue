  ...
  <div>
    ...
    <div class="col-span-3 row-span-2">
      <div style="z-index: 2; position: relative;" class="pl-20">
        <h2 class="text-base/7 font-semibold text-primary">Build Better</h2>
        <p class="mx-auto mt-2 font-primary text-4xl dark:text-gray-100 font-semibold  text-gray-950 sm:text-7xl">All Premium<br> Ui Components</p>
      </div>
    </div>
    ...
    <div class="col-span-3 row-span-3 row-start-3">
      <div style="width: 100%;position: relative;">
        <div style="position: absolute;top: 25px;">
          <img src="/assets/images/sec-2-1.png" alt="" style="border-radius: 60px;height: 300px;border: 3px solid #444;">
        </div>
        <div style="position: absolute;
             top: -26px;
    right: -50px;">
          <img src="/assets/images/sec-2-2.png" alt="" style="border-radius: 30px;height: 130px;border: 3px solid #3f3f3f;">
        </div>
        <div style="position: absolute;
  right: 35px;
    top: 149px;">
          <img src="/assets/images/sec-2-4.png" alt="" style="border-radius: 39px;height: 170px;border: 3px solid #888;">
        </div>
      </div>
    </div>
</div>
...
.section-2 .pattern-background-border {
  background-image: linear-gradient(to right, #110d20 1px, transparent 1px), linear-gradient(to bottom, #110d20 1px, transparent 1px);
}
